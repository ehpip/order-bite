...
export default function NewOrderSessionPage() {
  ...
  const [isCustomStore, setIsCustomStore] = useState(true);
  ...
  const [paymentNotes, setPaymentNotes] = useState(
    "Transfer to BCA 8830129482 a.n. Host or GoPay 0812345678",
  );
              ...
              <div>
                ...
                <div className="space-y-2">
                  {customItems.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex flex-col sm:flex-row sm:items-center gap-2 bg-white p-2 rounded-lg border border-slate-200"
                    >
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        <input
                          ...
                          value={item.name}
                          onChange={(e) =>
                            handleCustomItemChange(idx, "name", e.target.value)
                          }
                          className="flex-1 min-w-0 px-2 py-1 text-xs border border-slate-200 rounded outline-hidden"
                        />
                      </div>
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-full sm:w-32 sm:max-w-40 px-2 py-1 text-xs border border-slate-200 rounded outline-hidden"
                        />
