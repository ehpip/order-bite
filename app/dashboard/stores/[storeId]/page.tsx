    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-2xs overflow-hidden">
          ...
          <div className="p-6 pt-8 space-y-2 relative">
            <div className="absolute -top-5 left-6">
              <Skeleton className="h-16 w-16 rounded-2xl" />
            </div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div className="space-y-1.5 w-full sm:w-3/4">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <Skeleton className="h-8 w-full sm:w-52 rounded-xl" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl border p-4 shadow-2xs flex flex-col justify-between space-y-3"
            >
