...
import { ArrowLeft, Plus, FileSpreadsheet, Tag, Trash2, Edit2, Check, X, Search, Image as ImageIcon } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {filteredItems.length === 0 ? (
        <div className="bg-white p-12 text-center rounded-2xl border border-slate-200 text-slate-500 text-xs sm:text-sm">
          No menu items found. Click "+ Add Menu Item" or "Import CSV / Excel" to add items!
        </div>
      ) : (
